...
import { Calendar, Euro, MapPin, QrCode, ExternalLink, Eye, EyeOff, User, CheckCircle, XCircle } from 'lucide-react';
...
interface ReceivedReservationCardProps {
...
export const ReceivedReservationCard = ({ 
  reservation, 
  getStatusBadge, 
  onAcceptReservation, 
  onRejectReservation 
}: ReceivedReservationCardProps) => {
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-body">
                      ...
                      <Link 
                        ...
                        className="text-brand-600 hover:text-brand-700 hover:underline font-medium text-sm"
                      >
              ...
              <div className="flex flex-col items-end gap-3">
                ...
                {reservation.status === 'pending' && (
                  <div className="flex gap-2">
                    <Button
                      onClick={() => onAcceptReservation(reservation.id)}
                      variant="primary"
                      size="sm"
                    ...
                    <Button
                      onClick={() => onRejectReservation(reservation.id)}
                      variant="danger"
                      size="sm"
